      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-[1920px] mx-auto px-4 md:px-12 lg:px-20">
          ...
          {[
            ...
            { img: teamKenan, name: "KENAN YURTGÜN", title: "Kurucu Ortak", bio: "1986 yılında İstanbul Bakırköy'de doğan Kenan Yurtgün, inşaat sektöründeki kariyerine 2002 yılında aileden gelen köklü deneyim ve birikimin etkisiyle adım atmıştır. Eğitimini Beykent Üniversitesi İşletme Bölümü'nde tamamlayan Yurtgün, akademik bilgisini sahadaki uygulama deneyimiyle birleştirerek sektörde güçlü bir uzmanlık geliştirmiştir.\n\nMesleki kariyeri boyunca özellikle kat karşılığı inşaat ve kentsel dönüşüm projeleri alanlarında önemli projelerde görev almış; proje geliştirme, yatırım planlama, uygulama süreçleri ve stratejik yönetim konularında kapsamlı bir deneyim kazanmıştır. Edindiği bilgi ve tecrübeyle birçok projenin planlama ve hayata geçirilme süreçlerinde aktif rol üstlenmiştir.\n\n2024 yılı itibarıyla Servet İnşaat Kentsel Dönüşüm şirketinin kurucu ortakları arasında yer almıştır. Ancak Kenan Yurtgün ile Servet Uluç arasındaki iş birliği ve güçlü dostluk bağı, 2000'li yılların başına kadar uzanmaktadır. Güven, destek ve ortak vizyon üzerine kurulu bu ilişki, şirketin temel değerlerinin oluşmasında önemli bir rol oynamıştır.\n\nEvli ve iki çocuk babası olan Kenan Yurtgün'ün vizyonu; Servet İnşaat'ı sektöründe güvenilirliği, sağlamlığı ve sürdürülebilir büyüme stratejileriyle öne çıkan güçlü bir marka haline getirmektir. Misyonu ise modern, güvenli ve kaliteli yaşam alanlarını zamanında teslim ederek hem yatırımcılara hem de topluma kalıcı değer sunmaktır.", grayscale: true },
